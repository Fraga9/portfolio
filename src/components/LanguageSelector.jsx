...
export default function LanguageSelector() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 sm:right-0 left-0 sm:left-auto mt-2 w-40 sm:w-48 bg-black/90 backdrop-blur-md rounded-lg border border-white/10 shadow-xl overflow-hidden z-50">
